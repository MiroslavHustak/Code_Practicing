...
//overwriteOptions 0 = overwrite all, 1 = overwrite all older
//jina hodnota nez 0 ci 1 = neprovede se nic

//copyOptions 0 = extire folder incl. subfolders and folder content, 1 = folder content only (incl. subfolders)
//overwriteOptions 0 = overwrite all, 1 = overwrite all older
//other than 0 or 1 = no action
